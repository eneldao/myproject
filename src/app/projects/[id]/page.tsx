    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-6 text-white">
          ...
          <p className="mt-2 text-blue-100">Define your project details to get started with your freelancer</p>
        </div>
          ...
          <div className="bg-indigo-50 border-l-4 border-indigo-500 p-4 mx-6 mt-6 rounded-md flex items-center">
            ...
            <div className="ml-3 flex-1">
              <p className="text-sm text-indigo-800">
                ...
                {freelancerId && <span className="ml-1">Freelancer #{freelancerId}</span>}
        ...
        {submitSuccess && (
          <div className="mx-6 mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-md">
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-green-700">Project created successfully! Your freelancer will be notified.</p>
              </div>
            </div>
          </div>
        )}
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <span className="text-lg">{getServiceIcon(projectData.service_type)}</span>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-3xl mx-auto mt-6 text-center text-sm text-gray-500">
        <p>Need help? Contact support for assistance with creating your project.</p>
      </div>
    </div>
  );
}